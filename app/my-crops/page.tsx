      ...
      {showAddForm && (
        <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl shadow-green-100 border border-white p-6 mb-6 space-y-4">
          <div>
            ...
            <input
              type="text"
              className="w-full border-2 border-gray-200 rounded-2xl p-3 text-gray-900 font-medium placeholder:text-gray-400 bg-white focus:border-green-500 focus:outline-none shadow-sm"
          ...
          <div>
            ...
            <input
              type="date"
              className="w-full border-2 border-gray-200 rounded-2xl p-3 text-gray-900 font-medium bg-white focus:border-green-500 focus:outline-none shadow-sm"
              value={newSownDate}
