...
function ResultContent() {
  ...
  const hasImageResult = predictedIndex >= 0 || predictedIndex === -2;
  const advice = hasImageResult ? getAdviceByIndex(predictedIndex, lang, confidence) : null;
    ...
    <main className="min-h-screen bg-gradient-to-br from-green-50 via-emerald-50 to-lime-50 flex flex-col items-center justify-center p-6">
      <div className="w-full max-w-md mb-4 text-center">
        ...
        <h1 className="text-2xl font-extrabold text-gray-800 mt-2">
          {advice?.isUncertain ? "Photo Unclear" : "Your Advice Is Ready"}
        </h1>
      </div>
