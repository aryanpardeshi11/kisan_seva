    ...
    <main className="min-h-screen bg-gradient-to-br from-green-50 via-emerald-50 to-lime-50 p-6">
      ...
      <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl shadow-green-100 border border-white p-6 space-y-4">
        ...
        <div>
          ...
          <input
            type="text"
            className="w-full border-2 border-gray-200 rounded-2xl p-3.5 text-gray-900 font-medium placeholder:text-gray-400 bg-white focus:border-green-500 focus:outline-none shadow-sm"
            value={displayName}
        ...
        <div>
          ...
          <textarea
            className="w-full border-2 border-gray-200 rounded-2xl p-3.5 h-24 text-gray-900 font-medium placeholder:text-gray-400 bg-white focus:border-green-500 focus:outline-none resize-none shadow-sm"
