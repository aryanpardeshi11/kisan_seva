...
export default function CommunityPage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-green-50 via-emerald-50 to-lime-50 p-6">
      ...
      <input
        type="text"
        className="w-full border-2 border-gray-200 rounded-2xl p-3.5 bg-white text-gray-900 font-medium placeholder:text-gray-400 mb-6 focus:border-green-500 focus:outline-none shadow-sm"
